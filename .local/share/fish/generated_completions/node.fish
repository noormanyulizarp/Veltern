# node
# Autogenerated from man page /nix/store/0l5yh0rdzibk8arj9c8gzy1570jkc3vf-nodejs-16.18.1/share/man/man1/node.1.gz
...
complete -c node -l experimental-fetch -d 'Enable experimental support for the Fetch API'
