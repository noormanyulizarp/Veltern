...
} from "./chunk-AA2W5HOZ.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-ZOCTU5QN.js";
import {
  require_jsx_runtime
...
function useTabPanel(_ref) {
  ...
  const context = (0, import_react4.useContext)(TabContext_default);
  if (!context)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react5.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react5.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime5.jsx)(Tabs_default, {
  ...props,
...
"use client";
var TabContent = React8.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var TabPane = React9.forwardRef(({
  ...
  return (0, import_jsx_runtime7.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime7.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime7.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
// dep:react-bootstrap_Tab
var react_bootstrap_Tab_default = Tab_default;
export {
  react_bootstrap_Tab_default as default
};
/*
object-assign
(c) Sindre Sorhus
